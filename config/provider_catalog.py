...
BAILIAN_DEFAULT_BASE = "https://dashscope.aliyuncs.com/compatible-mode/v1"
...
PROVIDER_CATALOG: dict[str, ProviderDescriptor] = {
    ...
    "bailian": ProviderDescriptor(
        provider_id="bailian",
        transport_type="openai_chat",
        credential_env="BAILIAN_API_KEY",
        credential_url="https://help.aliyun.com/zh/model-studio/developer-reference/get-api-key",
        credential_attr="bailian_api_key",
        default_base_url=BAILIAN_DEFAULT_BASE,
        capabilities=("chat", "streaming", "tools", "thinking", "rate_limit"),
    ),
}
